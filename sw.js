...
const CACHE_VERSION = 'volcengine-presales-v18';
...
const PRECACHE_URLS = [
  ...
  './scripts/data.js?v=18',
  './scripts/quiz-data.js?v=18',
  './scripts/competition-data.js?v=18',
  './scripts/glossary.js?v=18',
  './scripts/app.js?v=18',
  './scripts/ai-chat.js?v=18',
  './lessons/_player.css?v=18',
  './lessons/_player.js?v=18',
  './lessons/day2-video.html?v=18',
  './lessons/day5-video.html?v=18',
  './lessons/day12-video.html?v=18',
  './icons/icon-96.png',
  './icons/icon-144.png',
  './icons/icon-180.png',
  './icons/icon-192.png',
