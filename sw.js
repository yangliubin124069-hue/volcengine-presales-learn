...
const CACHE_VERSION = 'volcengine-presales-v19';
...
const PRECACHE_URLS = [
  ...
  './scripts/data.js?v=19',
  './scripts/quiz-data.js?v=19',
  './scripts/competition-data.js?v=19',
  './scripts/glossary.js?v=19',
  './scripts/app.js?v=19',
  './scripts/ai-chat.js?v=19',
  './lessons/_player.css?v=19',
  './lessons/_player.js?v=19',
  './lessons/day2-video.html?v=19',
  './lessons/day5-video.html?v=19',
  './lessons/day12-video.html?v=19',
  './icons/icon-96.png',
  './icons/icon-144.png',
  './icons/icon-180.png',
  './icons/icon-192.png',
