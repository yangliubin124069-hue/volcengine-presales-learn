...
const CACHE_VERSION = 'volcengine-presales-v11';
...
const PRECACHE_URLS = [
  ...
  './scripts/data.js?v=11',
  './scripts/quiz-data.js?v=11',
  './scripts/competition-data.js?v=11',
  './scripts/glossary.js?v=11',
  './scripts/app.js?v=11',
  './scripts/ai-chat.js?v=11',
  './icons/icon-96.png',
  './icons/icon-144.png',
  './icons/icon-180.png',
  './icons/icon-192.png',
