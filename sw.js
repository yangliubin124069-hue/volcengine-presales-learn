...
const CACHE_VERSION = 'volcengine-presales-v14';
...
const PRECACHE_URLS = [
  ...
  './scripts/data.js?v=14',
  './scripts/quiz-data.js?v=14',
  './scripts/competition-data.js?v=14',
  './scripts/glossary.js?v=14',
  './scripts/app.js?v=14',
  './scripts/ai-chat.js?v=14',
  './lessons/day2-video.html?v=14',
  './icons/icon-96.png',
  './icons/icon-144.png',
  './icons/icon-180.png',
  './icons/icon-192.png',
